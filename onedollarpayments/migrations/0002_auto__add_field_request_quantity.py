...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.quantity'
        db.add_column(u'onedollarpayments_request', 'quantity',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=65, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.quantity'
        db.delete_column(u'onedollarpayments_request', 'quantity')
